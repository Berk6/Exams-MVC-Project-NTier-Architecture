        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestModels_AspNetUsers_CreaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersConnections", x => new { x.ConnectedUserId, x.MainUserId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UsersConnections_AspNetUsers_MainUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExamResults_TestModels_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamUserManyToMany", x => new { x.ExamId, x.UserId });
                    table.ForeignKey(
                        name: "ExamFK",
                        column: x => x.ExamId,
                        principalTable: "TestModels",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestQuestionManyToMany", x => new { x.QuestionId, x.TestId });
                    table.ForeignKey(
                        name: "QuestionFK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamUserManyToMany_UserId",
                table: "ExamUserManyToMany",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestModels_CreaterId",
                table: "TestModels",
                column: "CreaterId");

            migrationBuilder.CreateIndex(
                name: "IX_TestQuestionManyToMany_TestId",
                table: "TestQuestionManyToMany",
                column: "TestId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersConnections_MainUserId",
